...
const emptyForm = { title: "", contact_name: "", contact_phone: "", date: "", duration_minutes: 60, notes: "", result: "agendado" };
...
export default function Reunioes() {
  ...
  const openEdit = (m) => { setEditing(m); setForm({ title: m.title, contact_name: m.contact_name || "", contact_phone: m.contact_phone || "", date: m.date?.slice(0, 16) || "", duration_minutes: m.duration_minutes || 60, notes: m.notes || "", result: m.result || "agendado" }); setShowForm(true); };
